...
<head>
  ...
  <title>Register New Laundry</title>
  ...
  <div class="container">
    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-lg-3 d-none d-lg-block bg-register-image" style="background-image: url('{{ asset('images/register-bg.jpg') }}'); background-size: cover;"></div>
          <div class="col-lg-7">
            <div class="p-5">
